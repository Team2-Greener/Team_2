...
public class LikedViewAdapter extends RecyclerView.Adapter<LikedViewAdapter.ViewHolder> {
    ...
    private ArrayList<LikedList> arrayList;
    private Context context;

    public LikedViewAdapter(ArrayList<LikedList> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Glide.with(holder.itemView).load(arrayList.get(position).getLikedImage()).into(holder.liked_image);
        holder.liked_name.setText(arrayList.get(position).getLikedName());
        holder.liked_telNum.setText(arrayList.get(position).getLikedTel());
    }
